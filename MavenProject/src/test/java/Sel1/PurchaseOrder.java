...
// name of Employee for Tax Change
//Items Name , Rate ,Disc, Tax
// Flag For Open PO
//
...
{
	protected static Action seriesOfAction = null;
	...
	public static void main(String args[]) throws InterruptedException, IOException
	{
		...
		int flag = 1; // flag 1 i.e. open PO

		String UID = "uname";
		String Database = "bmsp"; String UserName="e0001";
		String PID = "pwd";
		...
		driver.findElement(By.id("month")).sendKeys("feb");  /*(Uncomment if feb Month is not Selected)*/
		...
		seriesOfAction =  Action.moveToElement(PartyName)
		...
		if(flag == 1)
		{
			...
			Auto_party_for_openPO.sendKeys(Party_Name);     						/// change name to check weather Open PO ID is showing or not.
			Thread.sleep(1000);
	...
	public void Item_Details(WebDriver driver, String Item_Name, String Min_Qty, String Max_Qty, String minimumQty,String Disc, String DueDays,int i) throws InterruptedException, IOException 
	{
		...
		if((!MinQty.getAttribute("value").isEmpty())&&(!Rate1.getAttribute("value").isEmpty())&&(!IGST.equals(0)))
		{
			...
			if(IGSTField == true) {
				...
				{
					System.out.println("\n");
/*CGST*/            String CGST_label = "/html/body/div/div/div[10]/div[2]/form[2]/div[2]/fieldset/table/tbody/tr/td[11]";
